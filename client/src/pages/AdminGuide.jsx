...
const CopyButton = ({ text }) => {
  ...
  return (
    <button
      onClick={copy}
      className="p-1.5 rounded-lg bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-500 dark:text-gray-400 transition-colors"
      title="Copy"
    >
      {copied ? (
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-12 animate-slide-up">
      ...
      <div className="text-center mb-12">
        <span className="inline-flex items-center gap-2 bg-purple-100 border border-purple-200 text-purple-700 dark:bg-purple-600/10 dark:border-purple-500/20 dark:text-purple-400 text-sm font-medium px-4 py-2 rounded-full mb-5">
          <FiShield size={14} />
          Admin Reference
        </span>
      ...
      {/* Credentials Card */}
      <div className="card border-2 border-indigo-300 dark:border-indigo-500/40 bg-indigo-50 dark:bg-indigo-500/5 mb-10">
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between bg-white dark:bg-gray-800 border border-amber-200 dark:border-gray-700 rounded-xl px-4 py-3">
            <div>
              <p className="text-xs text-gray-400 mb-0.5">Email</p>
              <p className="font-mono text-gray-800 dark:text-gray-200 font-medium">
                {email}
              </p>
            </div>
        ...
        <div className="space-y-4">
          {[
            ...
            },
            {
              ...
              color: "border-indigo-300 dark:border-indigo-500/30",
            },
            {
              n: "3",
            ...
            },
            {
              ...
              color: "border-orange-300 dark:border-orange-500/30",
            },
          ].map((step) => (
            <div
              key={step.n}
              className={`card flex gap-4 border-l-4 ${step.color}`}
            >
              <div className="w-8 h-8 bg-gray-100 dark:bg-gray-800 rounded-full flex items-center justify-center text-sm font-bold text-gray-600 dark:text-gray-400 shrink-0 mt-0.5">
                {step.n}
              </div>
              <div>
      ...
      <div className="card border border-amber-200 dark:border-gray-700 bg-amber-50/50 dark:bg-gray-900">
