...
const steps = [
  {
    ...
    accent: "border-indigo-300 dark:border-indigo-500/30",
  },
  {
    step: "02",
    icon: FiMail,
    ...
    accent: "border-purple-300 dark:border-purple-500/30",
  },
  {
    step: "03",
    icon: FiSearch,
    ...
    accent: "border-blue-300 dark:border-blue-500/30",
  },
  {
    step: "04",
    icon: FiBookOpen,
    ...
    accent: "border-green-300 dark:border-green-500/30",
  },
  {
    step: "05",
    icon: FiRotateCcw,
    ...
    accent: "border-orange-300 dark:border-orange-500/30",
  },
  {
    step: "06",
    icon: FiStar,
    ...
    accent: "border-yellow-300 dark:border-yellow-500/30",
  },
];
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-12 animate-slide-up">
      ...
      <div className="text-center mb-14">
        <span className="inline-flex items-center gap-2 bg-indigo-100 border border-indigo-200 text-indigo-700 dark:bg-indigo-600/10 dark:border-indigo-500/20 dark:text-indigo-400 text-sm font-medium px-4 py-2 rounded-full mb-5">
          <FiBook size={14} />
          User Guide
        </span>
      ...
      {/* Fine Policy */}
      <div className="card border border-red-200 dark:border-red-500/20 bg-red-50 dark:bg-red-500/5 mb-10">
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
              Books must be returned within <strong>14 days</strong>. Overdue
              returns incur a fine of <strong>₹10 per day</strong>. Fines are
          ...
          {features.map((f, i) => {
            ...
            return (
              <div key={i} className="card flex items-center gap-3 p-4">
                <div className="w-9 h-9 bg-indigo-100 dark:bg-indigo-500/20 rounded-xl flex items-center justify-center shrink-0">
                  <Icon
